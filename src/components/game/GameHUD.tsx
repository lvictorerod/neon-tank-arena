...
import { ArrowLeft, Heart, Target, Clock, Trophy, MousePointer, Zap } from 'lucide-react';
      ...
      <div className="fixed bottom-4 left-4 z-50">
        <Card className="bg-black/60 backdrop-blur-lg border-cyan-500/30 p-3 shadow-xl">
          <div className="text-xs text-gray-300 space-y-1">
            ...
            <div className="flex items-center gap-2">
              <span className="font-mono bg-gray-700/50 px-1 rounded">WASD</span>
              <span>Move tank</span>
            </div>
            <div className="flex items-center gap-2">
              <MousePointer className="w-3 h-3" />
              <span>Aim turret</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="font-mono bg-gray-700/50 px-1 rounded">CLICK</span>
              <span>Fire</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="font-mono bg-gray-700/50 px-1 rounded">SPACE</span>
              <span>Fire</span>
            </div>
          </div>
        </Card>
